...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id = $_POST["id"];
    $nombre = $_POST["Nombre"];
    $hijo_de =  $_POST["Hijo_de"];

    switch ($action) {
        case 'add':

            $msj = "0x1000";
            $affectedRows = InsertCategoria($nombre, $hijo_de);
            if ($affectedRows > 0) {
                $msj = "0x10";
            }
            break;
        ...
        case 'update':
            ...
            $msj = "0x20";
            $affectedRows = UpdateCategoria($id, $nombre, $hijo_de);
            if ($affectedRows == 0) {
                $msj = "0x1000";
            }
            break;
