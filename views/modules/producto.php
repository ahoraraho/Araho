...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($action) {
        case 'add':
            $msj = "0x400"; //BUG
            $affectedRows = InsertProducto($nombre, $precio, $marca, $categoria, $presentacion, $descripcion, $stock, $imagenNombre, $destacado, $tendencia);
            if ($affectedRows > 0) {
                $msj = "0x10";
        ...
        case 'update':
            ...
            $affectedRows = UpdateProducto($id, $nombre, $precio, $marca, $categoria, $presentacion, $descripcion, $stock, $sqlImagen, $destacado, $tendencia);
            if ($affectedRows == 0) {
                $msj = "0x400";
            }
            $msj = "0x20";
